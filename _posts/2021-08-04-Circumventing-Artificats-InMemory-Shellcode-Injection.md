...
---
The final piece of the shellcode loader consists of locating and calling the WaitForSingleObject API from kernel32.dll. Calling this function with the appropriate arguments will ensure that the shell will not instanteniously terminate and only stop when the shell thread itself is terminated. This is left as an exercise for the reader.
